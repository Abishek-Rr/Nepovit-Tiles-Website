...
if ( !function_exists( 'mahogany_woocommerce_get_css' ) ) {
	add_filter( 'mahogany_filter_get_css', 'mahogany_woocommerce_get_css', 10, 4 );
	function mahogany_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce span.onsale {
	...
	background-color: {$colors['alter_link3_07']};
}
.woocommerce .shop_mode_thumbs ul.products li.product .post_item .post_data, 
.woocommerce-page .shop_mode_thumbs ul.products li.product .post_item .post_data{
...
.woocommerce ul.products li.product .price del span, .woocommerce-page ul.products li.product .price del span,
...
.woocommerce ul.products li.product .post_item.post_layout_list .post_data {
...
.woocommerce ul.products li.product .post_data .add_to_cart_button:hover::after,
.woocommerce-page ul.products li.product .post_data .add_to_cart_button:hover::after {
	color: {$colors['text_dark']};
...
/* Shop mode selector */
.mahogany_shop_mode_buttons a {
	color: {$colors['alter_light']};
}
.mahogany_shop_mode_buttons a:hover {
	color: {$colors['text_dark']};
}
.shop_mode_thumbs .mahogany_shop_mode_buttons a.woocommerce_thumbs,
...
.woocommerce table.cart td.actions .coupon .input-text,
.woocommerce-page table.cart td.actions .coupon .input-text,
.woocommerce .shipping-calculator-form .select_container:before,
.woocommerce-page .shipping-calculator-form .select_container:before,
.woocommerce .shipping-calculator-form .select2-container.select2-container--default span.select2-selection,
.woocommerce-page .shipping-calculator-form .select2-container.select2-container--default span.select2-selection,
.woocommerce .shipping-calculator-form .select2-container.select2-container--default span.select2-selection .select2-selection__rendered,
.woocommerce-page .shipping-calculator-form .select2-container.select2-container--default span.select2-selection .select2-selection__rendered,
...
.trx_addons_attrib_item.trx_addons_attrib_button:hover span{
	color: {$colors['inverse_link']};
}
...
/* product category */
.woocommerce ul.products li.product.product-category .post_data .post_header a, 
.woocommerce-page ul.products.product-category li.product .post_data .post_header a {
	background-color: {$colors['alter_link3_07']};
	color: {$colors['inverse_link']};
}
