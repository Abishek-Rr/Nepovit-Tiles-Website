...
if (!function_exists('mahogany_trx_addons_get_css')) {
	add_filter('mahogany_filter_get_css', 'mahogany_trx_addons_get_css', 10, 4);
	function mahogany_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
ul[class*="trx_addons_list_custom"] li:nth-child(2n+1) {
...
.slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_bd_color_03']};
	border-color: {$colors['alter_bd_color_03']};
}
...
.widget_contacts .contacts_info .contacts_phone a:hover{
...
.widget_contacts .contacts_info .contacts_email a:hover {
	border-color: {$colors['alter_link']};
}
...
.content .wpb_column .widget_contacts .contacts_info,
.content .scheme_self.wpb_column .widget_contacts .contacts_info{
	color: {$colors['text_dark']};
}
.content .widget_contacts .contacts_icon,
.content .scheme_self.wpb_column .widget_contacts .contacts_icon {
	color: {$colors['text_dark']};
	border-color: {$colors['text_dark']};
}
.content .widget_contacts .contacts_info [class*="_label"],
.content .scheme_self.wpb_column .widget_contacts .contacts_info [class*="_label"] {
	color: {$colors['text_dark']};
}
.content .widget_contacts .contacts_info .contacts_phone a,
.content .scheme_self.wpb_column .widget_contacts .contacts_info .contacts_phone a{
	color: {$colors['text_link3']};
}
.content .widget_contacts .contacts_info .contacts_phone a:hover,
.content .scheme_self.wpb_column .widget_contacts .contacts_info .contacts_phone a:hover{
	color: {$colors['text_hover3']};
}
.content .widget_contacts .contacts_info .contacts_email a,
.content .scheme_self.wpb_column .widget_contacts .contacts_info .contacts_email a {
	color: {$colors['text_link3']};
	border-color: {$colors['text_link3']};
}
.content .widget_contacts .contacts_info .contacts_email a:hover,
.content .scheme_self.wpb_column .widget_contacts .contacts_info .contacts_email a:hover {
	color: {$colors['text_hover3']};
	border-color: {$colors['text_hover3']};
}
.content .widget_contacts .socials_wrap .social_item.contacts_socials_label,
.content .scheme_self.wpb_column .widget_contacts .socials_wrap .social_item.contacts_socials_label {
	color: {$colors['text_dark']};
}
...
.sc_icons .sc_icons_item_linked .sc_icons_icon:hover {
	color: {$colors['extra_link2']};
	background-color: {$colors['text_link3_05']};
}
.sc_icons .sc_icons_item_title {
	color: {$colors['text_dark']};
}
...
.sc_icons.empty_icon .sc_icons_item:hover .sc_icons_item_title{
	color: {$colors['text_link']};
}
...
.sc_price_default .sc_price_item .sc_price_item_icon {
	color: {$colors['extra_link']};
}
...
.sc_price_default .sc_price_item .sc_price_item_title{
	background-color: {$colors['alter_link']};
}
.sc_price_default .sc_price_item .sc_price_item_title,
.sc_price_default .sc_price_item .sc_price_item_title a {
	color: {$colors['inverse_link']};
}
...
.sc_price_default .sc_price_item .sc_price_item_description,
.sc_price_default .sc_price_item .sc_price_item_details {
	color: {$colors['alter_dark']};
}

/* alter */
.sc_price_alter .sc_price_item_price .sc_price_item_price_before,
.scheme_self.sc_price_alter .sc_price_item_price .sc_price_item_price_before{
	color: {$colors['alter_link']};
}
.sc_price_alter .sc_price_item_price .sc_price_item_price_value,
.scheme_self.sc_price_alter .sc_price_item_price .sc_price_item_price_value{
	color: {$colors['alter_dark']};
}
.sc_price_alter .sc_price_item_price .sc_price_item_price_after,
.scheme_self.sc_price_alter .sc_price_item_price .sc_price_item_price_after{
	color: {$colors['alter_dark']};
}
...
body.archive[class*="services"] .sc_services_item:hover .sc_services_item_header a{
	color: {$colors['text_link']};
}
...
.sc_services_list .sc_services_post_featured:hover .sc_services_item_number {
	color: {$colors['text_link']};
	border-color: {$colors['text_link']};	
}
...
.sc_testimonials.sc_testimonials_simple .slider_outer .slider_pagination_wrap .swiper-pagination-bullet {
	background-color: {$colors['text_dark_04']};
}
.sc_testimonials.sc_testimonials_simple .slider_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active {
	background-color: {$colors['text_dark']};
}
