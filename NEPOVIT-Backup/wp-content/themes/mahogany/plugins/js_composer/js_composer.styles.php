...
if ( !function_exists( 'mahogany_vc_get_css' ) ) {
	add_filter( 'mahogany_filter_get_css', 'mahogany_vc_get_css', 10, 4 );
	function mahogany_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_general.vc_tta.vc_tta-tabs.vc_tta-style-modern .vc_tta-tabs-container .vc_tta-tabs-list .vc_tta-tab > a:hover{
}
.vc_general.vc_tta.vc_tta-tabs.vc_tta-style-modern .vc_tta-tabs-container .vc_tta-tabs-list .vc_tta-tab.vc_active > a {
	color: {$colors['inverse_hover']};
	background-color: {$colors['text_link']};
}
