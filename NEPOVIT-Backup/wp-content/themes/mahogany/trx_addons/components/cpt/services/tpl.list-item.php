...
<div class="sc_services_item without_content<?php
	mahogany_show_layout($args['featured']=='image'
					? ' with_image' 
					: ($args['featured']=='icon' 
						? ' with_icon' 
...
?>><div class="sc_services_post_featured">
	<?php
		...
		if ( has_post_thumbnail() && $args['featured']=='image') {
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters('trx_addons_filter_args_featured', array(
																...
																'hover' => false,
																'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('servlist'), 'services-list')
																),
															'services-list'
															)
										);
