...
jQuery(document).ready(function() {
    ...
    function mahogany_resize_video(cont) {
        ...
        cont.find('.video_frame iframe, iframe').each(function() {
            ...
            if (typeof iframe.attr('src') !== 'undefined' && iframe.attr('src').indexOf('soundcloud')>0) return;
	...
	//=====================================================
	jQuery(".sc_price a[href^=http]").each(function(){
