...
class WPBakeryShortCode_ts_side_image_right extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		?>
		<div class="side-image-right <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
...
vc_map( array(
	"base" 			    => "ts_side_image_right",
	"name" 			    => __( 'Side Image Right', 'themezinho' ),
