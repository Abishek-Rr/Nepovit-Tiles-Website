...
class WPBakeryShortCode_ts_side_text_left extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		?>
		<div class="side-text-left <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
...
vc_map( array(
	"base" 			    => "ts_side_text_left",
	"name" 			    => __( 'Side Text Left', 'themezinho' ),
